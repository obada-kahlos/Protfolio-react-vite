...
const SkillCart = ({ text, icon, level }) => {
  return (
    <div className="transition duration-300 dark:hover:bg-[rgba(0,0,0,0.3)] hover:bg-[rgba(125,125,125,0.1)] w-full rounded-lg flex items-start md:gap-4 gap-1 md:p-2 p-1 cursor-pointer">
      <div>{icon}</div>
      <div>
